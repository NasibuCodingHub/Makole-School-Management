...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // $addTeacherDetailQuery ="INSERT INTO `teachers`(`s_no`, `id`, `fname`, `lname`, `father`, `subject`, `gender`, `dob`, `image`, `phone`, `email`, `address`, `city`, `zip`, `state`, `class`, `section`) VALUES (NULL,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
