        ...
        <div class="bottom-data">
            ...
            <div class="orders">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li> 
                    <button class="nav-link view-HomeWork-tab" id="homework-tab" data-bs-toggle="tab" data-bs-target="#homework" type="button" role="tab" aria-controls="homework" aria-selected="false">Login History
                            </button>
                    </li>
                </ul>
...
// Fetch login history data for students only
$query = "SELECT lh.*, u.role FROM login_history lh 
...
<div class="s">
    <div class="header">
        ...
        <h3 id="h11">Students Login History</h3>
    </div>

    <!-- Table to display login history data -->
    <table class="table table-striped">
        ...
        <tbody>
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo "<tr><td colspan='5'>No login history found for students.</td></tr>";
            }
            ?>
        </tbody>
    </table>
