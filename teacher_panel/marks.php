        ...
        <div class="bottom-data">
            ...
            <div class="orders">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                   ...
                   <li> 
                    <button class="nav-link view-HomeWork-tab" id="homework-tab" data-bs-toggle="tab" data-bs-target="#homework" type="button" role="tab" aria-controls="homework" aria-selected="false">View
                            HomeWork</button>
                    </li>
                ...
                <div class="tab-content">
                    ...
                    <!-- start of homework tab  -->

                    <div class="tab-pane fade" id="homework" role="tabpanel" aria-labelledby="homework-tab"><br>
    <div class="s">
        <div class="header">
            <i class='bx bx-book'></i>
            <h3 id="h11">Students Home Works</h3>
        </div>
...
// Query to fetch homework answers, ordered by upload time
$sql = "SELECT * FROM homework_answers ORDER BY upload_time DESC";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo '<table class="table" id="homework-table">';
    echo '<thead>';
    echo '<tr>';
    ...
    echo '<th scope="col">Upload Time</th>';
    ...
    while ($row = $result->fetch_assoc()) {
        echo '<tr data-subject="' . htmlspecialchars($row["subject"]) . '">';
        echo '<th scope="row">' . htmlspecialchars($row["fname"]) . '</th>';
        echo '<td>' . htmlspecialchars($row["student_id"]) . '</td>';
        echo '<td>' . htmlspecialchars($row["subject"]) . '</td>';
        echo '<td>' . htmlspecialchars($row["file_name"]) . '</td>';
        echo '<td>' . htmlspecialchars($row["upload_time"]) . '</td>';
        echo '<td>';
        echo '<a href="../homeworkUploads/' . urlencode($row["file_name"]) . '" target="_blank" class="btn btn-secondary btn-sm mr-2">';
        echo '<i class="fa fa-eye"></i> View';
        echo '</a>';
        
        // Download button
        echo '<a href="download.php?file=' . urlencode($row["file_name"]) . '" class="btn btn-primary btn-sm">';
    ...
    $subjectSql = "SELECT DISTINCT subject FROM homework_answers";
    ...
    // Display the delete form and download button
    echo '<div class="d-flex justify-content-between mt-3">';
    
    // Minimized Download All Button with Icon
    echo '<a href="download_all.php" class="btn btn-primary d-flex align-items-center">';
    echo '<i class="fa fa-download mr-2"></i>Download All';
    echo '</a>';
    
    echo '<form id="delete-form" class="form-inline">';
    echo '<div class="form-group">';
    echo '<label for="subject" class="mr-2">Delete Subject:</label>';
    echo '<select name="subject" id="subject" class="form-control mr-2">';
    ...
    echo '</select>';
    echo '<button type="button" id="delete-btn" class="btn btn-danger" data-confirm="Are you sure you want to delete all homework for the selected subject? ' . $subject . '">Delete Selected Subject</button>';
    echo '</div>';
    echo '</form>';
    echo '</div>';
    ...
    // Echo the JavaScript to handle the button click
    echo '<script>
                            ...
                            if (xhr.status >= 200 && xhr.status < 300) {
                                ...
                                swal(response.message, {
                                    ...
                                    if (response.status === "success") {
                                        // Remove rows related to the deleted subject
