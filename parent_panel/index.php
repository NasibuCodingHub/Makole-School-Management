...
<body>
    ...
    <div class="container">
        <aside>
            <div class="profile">
            <h2 class='text-muted'>Parent</h2><br>
                <div class="top">
                    ...
                    <div class="info">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "
                            <p>For, <b>" . $row["fname"] . "</b> " . $row["lname"] . "</p>
...
$sql_query = "SELECT * FROM notice WHERE (role = 'student' AND class='$class') OR (role = 'NULL' OR role='') ORDER BY s_no DESC LIMIT 3";
