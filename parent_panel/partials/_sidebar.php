...
<div class="sidebar">
    <a href="dashboard.php" class="logo">
        ...
        <img src="../images/1.jpg">
          <div class="logo-name"><span class="text-warning">M</span><span class="darkTextColor">P</span><span class="text-warning">S</span></div>
</a>
    ...
    <ul class="side-menu main-side-board">
        ...
        <li><a href="student.php"><i class='bx bxs-user-detail'></i>Student/Parent</a></li>
