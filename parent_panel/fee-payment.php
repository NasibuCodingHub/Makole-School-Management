...
<body>
  ...
  <?php include('partials/select_classes.php') ?>
                  ...
                  <br>
                  Tsh: <input type="text" name="" value="Amount" id="money" disabled>
                </div>
              </div>
               
              <!-- payment details for NMB -->
             <div >
               <h2><span class="btn btn-success ">NMB ACCOUNT</span>  12728129467859</h2>
               <h2> <span class="btn btn-success ">CRDB ACCOUNT</span>  43495669785495</h2>
               <br><hr>
               <p >Name: Makole Primary School</p>

             </div>
              
              <button type="submit" class="btn btn-success btn-lg mb-1"
              style="margin-top: 8%;">NMB /CRDB To Pay</button>
