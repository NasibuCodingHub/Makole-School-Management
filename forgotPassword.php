...
function getEmailObject($reciever, $otp){
    ...
    $title = 'Makole OTP Verification email';
    $message = '<h3>OTP Verification email</h3><p>Your one time password is <b>'.$otp.'</b>. Stay connected with Makole primary school.</p><p>This email is computer generated so please do not reply this email.</p>';
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'nasibu1905@gmail.com';
    $mail->Password = 'sabfodtmxvqrbovm'; 
    $mail->SMTPSecure = 'tls';  
    $mail->Port = 587;
